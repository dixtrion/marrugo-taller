...
with tabs[0]:
    ...
    cm = st.number_input("Circunferencia del tubo (cm):", min_value=0.0, step=0.1, key="cm_web")
...
with tabs[1]:
    ...
    mm = st.number_input("Espesor de pared (mm):", min_value=0.0, step=0.01, format="%.2f", key="mm_web")
